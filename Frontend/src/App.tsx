  ...
  const handleRightClickExplorerDiv = (event) => {
    ...
    setMenuContextuel({
      ...
      actions: [
        ...
        { label: "Ajouter note", onClick: () => alert("A modifier : en attende du backend, code deja écris et en commantaire sur la meme ligne que cette alert") /*createNote(0 , "", "").then(() => fetchChildItems())*/ },
      ],
